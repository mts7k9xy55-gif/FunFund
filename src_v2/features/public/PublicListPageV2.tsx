    ...
    <div className="min-h-screen bg-gradient-to-b from-[#f8fcff] via-[#f6f8ff] to-[#f9f7fb] text-slate-900">
      ...
      <main className="mx-auto max-w-7xl px-4 py-8">
        <section className="mb-8 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
          <h1 className="text-3xl font-black tracking-tight text-slate-900">Public Board (Optional)</h1>
          <p className="mt-2 text-sm text-slate-600">
            このサービスはクローズドSNS運用が基本です。公開投稿がある場合のみ表示します。
          </p>
        ...
        {filtered.length === 0 ? (
          <section className="rounded-2xl border border-dashed border-slate-300 bg-white p-12 text-center">
            <h2 className="text-lg font-semibold text-slate-800">公開投稿はまだありません</h2>
            <p className="mt-2 text-sm text-slate-500">プロジェクト作成は必須ではありません。クローズドRoomで議論を進めてください。</p>
          </section>
        ) : (
